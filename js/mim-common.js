      ...
      **/
        jQuery.fn.drawerInit = MIM.drawerInit = function (str) {
            ...
            function drawer() {
                ...
                var mimDrawerCont = '';
                if (title) {
                    mimDrawerCont = $('<mim-drawer-cont><h2><span>' + title + '</span><i class="iconfont mim-closeChangeDiv">&#xe70e;</i></h2></mim-drawer-cont>');
                } else {
                    mimDrawerCont = $('<mim-drawer-cont></mim-drawer-cont>');
                }
